...
powershell -Command "(gc -en utf8 install.rdf) -replace 'pre%oldRev%', 'pre%FiltaQuillaRev%' | Out-File install.rdf"
...
rename FiltaQuilla.zip FiltaQuilla-1.4pre%FiltaQuillaRev%.xpi
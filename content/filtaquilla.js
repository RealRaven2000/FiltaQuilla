...
/*    
    ...
    */
    ...
    self.subjectRegex =
    {
      ...
      match: function subjectRegEx_match(aMsgHdr, aSearchValue, aSearchOp) {
        let subjectRegexCallback = new regexUtil.RegexCallback(RegExp(_getRegEx(aSearchValue)));
   ...
   // local object used for callback
    ...
    self.subjectBodyRegex =
    {
      ...
      name: self.strings.GetStringFromName("filtaquilla.subjectbodyregex.name"),
